      ...
      <CCardBody class="fixed-table">
        <router-link :to="{ name: 'Create Customers' }">
          <CButton class="me-2" color="primary">
            <CIcon class="text-white" name="cil-plus"/> Add Customer
          </CButton>
        </router-link>
        <CTable class="border border-top-0" hover responsive>
          <CTableHead color="light">
            <CTableRow>
              ...
              <CTableHeaderCell class="text-center">Phone</CTableHeaderCell>
              <CTableHeaderCell class="text-center">Address</CTableHeaderCell>
